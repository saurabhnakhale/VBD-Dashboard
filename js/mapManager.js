 ...
 * Uses Ward GeoJSON boundaries (WARDS_GEOJSON), Ward-to-Zone Mapping (WARD_ZONE_MAPPING),
 * choropleth polygons with case heat density, center label badges, and healthcare nodes.
 */
